...
public class RequestRepositoryTests {
	...
	@Test
	public void AsaveTest() { 		//Metodo que registra novo pedido
		User owner = new User();
		owner.setId(1L);
	...
	@Test
	public void updateTest() { 		//Metodo que modifica o pedido
		User owner = new User();
		owner.setId(1L);
	...
	@Test
	public void getByIdTest() { 	//Metodo que busca um pedido especifico
