...
public class RequestStageRepositoryTests {
	...
	public void asaveTest() {
		...
		RequestStage stage = new RequestStage(null, "Fui comprar um novo laptop de marca HD e com 16 GB de RAM", new Date(),  RequestState.CLOSED, request, owner);
	...
	public void getByIdTest() {
		...
		assertThat(stage.getDescription()).isEqualTo("Fui comprar um novo laptop de marca HD e com 16 GB de RAM");
